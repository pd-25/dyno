<aside class="main-sidebar fixed offcanvas shadow" data-toggle='offcanvas'>
    <section class="sidebar">
        <div class="w-80px mt-3 mb-3 ml-3">
            <img src="{{url('admin/assets/img/basic/logo.png')}}" alt="">
        </div>
        <div class="relative">
            ...
            <div class="user-panel p-3 light mb-2">
                <div>
                    <div class="float-left image">
                        <img class="user_avatar" src="{{url('admin/assets/img/dummy/u2.png')}}" alt="User Image">
                    </div>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href="#">
                ...
                <ul class="treeview-menu">
                    <li><a href="javascript:void(0);"><i class="icon icon-circle-o"></i>All Courses</a>
                    </li>
                    <li><a href="javascript:void(0);"><i class="icon icon-add"></i>Add
                        New </a>
                    </li>
                </ul>
            </li>
